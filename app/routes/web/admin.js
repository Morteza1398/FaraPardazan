...
const taskController = require('app/http/controllers/admin/taskController');
...
const taskValidator = require('app/http/validators/taskValidator');
...
// Task Routes
router.get('/tasks' , gate.can('sht') , taskController.index);
